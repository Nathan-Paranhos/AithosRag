// Design Tokens - Sistema de Design Profissional Aithos RAG
...
export const themes = {
  light: {
    ...
    card: colors.secondary[0] || '#ffffff',
    cardForeground: colors.secondary[950],
    popover: colors.secondary[0] || '#ffffff',
    popoverForeground: colors.secondary[950],
    primary: colors.primary[500],
    primaryForeground: colors.primary[50],
